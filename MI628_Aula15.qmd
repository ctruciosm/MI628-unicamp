...
- Cornfields et al. (1959) tomam uma perspectiva mais construtiva e perguntam-se: Quão forte esse variável de confusão deve ser para explicar a associação observada entre $Z$ (fumar cigarro) e $Y$ (câncer de pulmão)?
:::
...
Este teorema nos da um valor máximo para $RR^{\rm{Obs}}_{ZY|x}$ se $Z  \perp\!\!\!\!\perp Y | (X, U)$ for verdade.
