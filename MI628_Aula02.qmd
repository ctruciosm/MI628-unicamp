...
- Sob $H_{0F}$, $\dfrac{n_1 n_0}{n} \tau^2 \rightarrow 0$
...
- Não apenas a diferencia de médias pode ser utilizada no contexto de FRT (ou equivalentemente $\tau \Big / \sqrt{\dfrac{n}{n_1 n_0}S^2}$). 
