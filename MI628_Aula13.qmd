...
- Seja o _index_ $ij$ que representa a unidade $j$ no conjunto $i$ ($i = 1, \cdots, n$, $j = 1, \cdots, M_i + 1$) com indicadora de tratamento $Z_{ij}$ e resultados potenciais $Y_{ij}(1)$ e $Y_{ij}(0).$
...
- Quando $X$ tem dimensão grande, _matching_ sofre com a maldição da dimensionalidade.
